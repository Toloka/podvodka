...
parser.add_argument('-r', '--remove_prompts_without_meaning', type=bool, required=False, default=True,
                    help='''Determine whether Discord prompts that do not describe a specific object should be removed from 
                            the output file. If not, the image description will have the value "_no_object".''')
